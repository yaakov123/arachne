<template>
    <div class="settings-container">
        <div class="settings-header">
            <h1>Settings</h1>
            <p>
                Manage projects, proxy server, and certificate authority
                settings
            </p>
        </div>
                ...
                <div class="section-content">
                    <div class="control-group">
                        <div class="control-info">
                            ...
                            <p>
                                Create and manage the Root Certificate Authority
                    ...
                    <!-- Trust Instructions -->
                    <div
                        v-if="caExists && trustInstructions"
                        class="control-group"
                    >
                        <div class="control-info">
                        ...
                        <div class="trust-instructions">
                            ...
                            <div
                                v-if="
                                    trustInstructions.untrustCommands.length > 0
                                "
