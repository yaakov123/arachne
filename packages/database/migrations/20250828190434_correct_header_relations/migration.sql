/*
  ...
  - You are about to drop the column `transactionId` on the `transaction_headers` table. All the data in the column will be lost.
...
INSERT INTO "new_transaction_headers" ("headerType", "id", "name", "sensitive", "value") SELECT "headerType", "id", "name", "sensitive", "value" FROM "transaction_headers";
